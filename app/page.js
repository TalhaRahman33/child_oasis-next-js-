...
const page = () => {
          ...
          >
            <ul className="navbar-nav m-auto">
              ...
              <li className="custom-button">
                <Link href="pricing.html" className="custom-btn">
                  باقات الاشتراك
                </Link>
              </li>
            </ul>
            ...
            <div className="modal-header">
              ...
              <div className="frm-all-btn">
                ...
                <div className="social-link">
                  <ul>
                    <li>
                      <Link href={"3"} className="color-1">
                        <i className="flaticon-facebook-logo" />
                      </Link>
                    </li>
                    <li>
                      <Link href={"3"} className="color-2">
                        <i className="flaticon-google-plus-symbol" />
                      </Link>
                    </li>
                    <li>
                      <Link href={"3"} className="color-3">
                        <i className="flaticon-twitter-black-shape" />
                      </Link>
                    </li>
                    <li>
                      <Link href={"3"} className="color-4">
  ...
  <section className="program-section pt-100 pb-100">
    <div className="container">
      <div className="section-title text-center">
        ...
        <ExportedImage src="/images/title-border.png" alt="Image" width={127} height={8} />
      </div>
      <div className="program-slider owl-carousel owl-theme">
        <div className="single-program">
          <div className="image">
            <Link href="program-details.html">
              <ExportedImage 
              unoptimized={true} 
              src="/images/play activity.jpg" 
              alt="Image" 
              width={352} 
              height={262}/>
            </Link>
        ...
        <div className="single-program">
          <div className="image">
            <Link href="program-details.html">
              <ExportedImage unoptimized={true} src="/images/science activity.jpg" alt="Image" width={352} height={262} />
            </Link>
          </div>
          <div className="image-caption">
            <div className="pr-content">
        ...
        <div className="single-program">
          <div className="image">
            <Link href="program-details.html">
              <ExportedImage unoptimized={true} src="/images/3_1.jpg" alt="Image"  width={352} height={262}/>
            </Link>
          </div>
          <div className="image-caption">
            <div className="pr-content">
  ...
  <section className="event2-section pt-100 pb-70">
    <div className="container">
      <div className="section-title text-center">
        <h6>الجدول</h6>
        <h2>الجدول الزمني </h2>
        <ExportedImage unoptimized={true} src="/images/title-border.png" alt="Image" width={127} height={8} />
      </div>
    ...
    <div className="event-shape">
      <div className="shape1">
        <ExportedImage unoptimized={true} src="/images/shape7.png" alt="Shape" width={37} height={94} />
      </div>
      <div className="shape2">
      <ExportedImage unoptimized={true} src="/images/shape8.png" alt="Shape" width={40} height={38} />
      </div>
      <div className="shape3">
      <ExportedImage unoptimized={true} src="images/shape9.png" alt="Shape" width={40} height={42} />
      </div>
      <div className="shape4">
      <ExportedImage unoptimized={true} src="/images/shape10.png" alt="Shape" width={40} height={39} />
      </div>
      <div className="shape5">
      <ExportedImage unoptimized={true} src="/images/shape11.png" alt="Shape" width={40} height={56} />
      </div>
      <div className="shape6">
      <ExportedImage unoptimized={true} src="/images/shape12.png" alt="Shape" width={40} height={37} />
      </div>
    </div>
  </section>
  {/* End Event2 Section */}
  ...
  <section className="plan-section pt-100 pb-70">
      ...
      <div className="row">
        <div className="col-md-6 col-lg-4">
          <div className="single-plan">
            ...
            <div className="img-shape">
              <ExportedImage unoptimized={true} src="images/shape3_2.png" alt="Image" width={90} height={89} />
            </div>
            <div className="card-button">
              <Link href="contact.html" className="card-btn">
                اختر الباقة
              </Link>
            </div>
          </div>
    ...
    <div className="plan-shape-image">
      <div className="shape1">
        <ExportedImage unoptimized={true} src="images/shape1_2.png" alt="Image" width={66} height={126} />
      </div>
      <div className="shape2">
        <ExportedImage unoptimized={true} src="images/shape2_2.png" alt="Image" width={66} height={126} />
      </div>
    </div>
  </section>
  {/* End Plan Section */}
  ...
  <section className="testimonial2-section ptb-100">
    <div className="container">
      <div className="section-title text-center">
        ...
        <ExportedImage unoptimized={true} src="images/title-border2.png" alt="Image" width={127} height={8} />
      </div>
          ...
          <div>
            <div className="item">
              <div className="sl-img">
                <ExportedImage unoptimized={true} src="images/slider-img1.png" alt="image" width={75} height={75} />
              </div>
            </div>
            <div className="item">
              <div className="sl-img">
              <ExportedImage unoptimized={true} src="images/slider-img3.png" alt="image" width={75} height={75} />
              </div>
            </div>
            <div className="item">
              <div className="sl-img">
              <ExportedImage unoptimized={true} src="images/slider-img4.png" alt="image" width={75} height={75} />
              </div>
            </div>
            <div className="item">
              <div className="sl-img">
    ...
    <div className="testimonial-shape">
      ...
      <div className="shape2">
        <ExportedImage unoptimized={true} width={37} height={94} src="/images/shape7.png" alt="Shape" />
      </div>
      <div className="shape3">
      <ExportedImage unoptimized={true} src="/images/shape7.png" alt="Shape" width={37} height={94} />
      </div>
  ...
  <section className="member-section pt-100 pb-70">
    <div className="container">
     ...
     {/* <ExportedImage unoptimized={true} width={127} height={8} src="/images/title-border.png" alt="Image" /> */}
      </div>
      <div className="row">
        <div className="col-md-6 col-lg-4">
          <div className="single-member">
            <div className="image">
              <ExportedImage unoptimized={true}  src="/images/t2.png" alt="Image" height={166} width={166} />
            </div>
        ...
        <div className="col-md-6 col-lg-4">
          <div className="single-member">
            <div className="image">
            <ExportedImage unoptimized={true}  src="/images/t1.png" alt="Image" height={166} width={166} />
            </div>
            <div className="text-content">
              <h3>هياء السبعان</h3>
        ...
        <div className="offset-md-3 offset-lg-0 col-md-6 col-lg-4">
          <div className="single-member">
            <div className="image">
            <ExportedImage unoptimized={true}  src="/images/t3.png" alt="Image" height={166} width={166} />
            </div>
            <div className="text-content">
              <h3>أسرار المديد</h3>
              <h5>معلمة حضانة</h5>
    ...
    <div className="container">
      <div className="logo-slider owl-carousel owl-theme">
        <div className="single-logo">
          <ExportedImage unoptimized={true} width={100} height={130} src="/images/1_2.png" alt="Logo" />
        </div>
        <div className="single-logo">
        <ExportedImage unoptimized={true} width={100} height={130} src="/images/2_3.png" alt="Logo" />
        </div>
        <div className="single-logo">
        <ExportedImage unoptimized={true} width={100} height={130} src="/images/3_3.png" alt="Logo" />
        </div>
        <div className="single-logo">
        <ExportedImage unoptimized={true} width={100} height={130} src="/images/4_1.png" alt="Logo" />
        </div>
      </div>
    </div>
  </div>
      ...
      <div className="blog-slider-two owl-carousel owl-theme">
        <div className="single-blog">
          <div className="blog-image">
            <a href="How-to-motivate-your-child-to-read-details.html">
              <ExportedImage unoptimized={true} src="/images/1.jpg" alt="Image" width={352} height={262}/>
            </a>
          </div>
        ...
        <div className="single-blog">
          <div className="blog-image">
            ...
            <ExportedImage unoptimized={true} src="/images/2.jpg" alt="Image" width={352} height={262}/>
            </a>
          </div>
          <div className="img-caption">
            <div className="blog-chat-list">
        ...
        <div className="single-blog">
          <div className="blog-image">
            ...
            <ExportedImage unoptimized={true} src="/images/9.jpg" alt="Image" width={352} height={262}/>
            </a>
          </div>
          <div className="img-caption">
            <div className="blog-chat-list">
      ...
      <div className="blog-baby-image">
        <ul>
          <li className="image-1">
            <ExportedImage unoptimized={true} src="/images/5_1.png" alt="Image" width={155} height={134} />
          </li>
          <li className="image-1">
          <ExportedImage unoptimized={true} src="/images/6_1.png" alt="Image" width={155} height={142} />
          </li>
          <li className="image-1">
          <ExportedImage unoptimized={true} src="/images/5_1.png" alt="Image" width={155} height={134} />
          </li>
